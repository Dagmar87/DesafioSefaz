...
public class UsuarioDAOImpl implements UsuarioDAO{
	...
	public void inserirUsuario(Usuario usuario) {
		...
		String sqlUsuario = "INSERT INTO USUARIO (CPF, NOME, EMAIL, SENHA, TELEFONE) VALUES (?,?,?,?,?)";
	...
	public void editarUsuario(Usuario usuario) {
		...
		String sqlUsuario = "UPDATE USUARIO U SET U.CPF = ?, U.NOME = ?, U.EMAIL = ?, U.SENHA = ?, U.TELEFONE = ?"
							+ "WHERE U.CPF = ?";
	...
	public void deletarUsuario(Usuario usuario) {
		...
		String sqlUsuario = "DELETE FROM USUARIO U WHERE U.CPF = ?";
	...
	public Usuario pesquisarLogin(String cpf) {
		...
		String sql = "SELECT U.CPF, U.NOME, U.EMAIL, U.SENHA, U.TELEFONE FROM USUARIO U WHERE CPF = ?";
	...
	public List<Usuario> pesquisarUsuario(String cpf, String nome) {
		...
		String sql = "SELECT DISTINCT U.CPF," +
					" 	U.NOME, " +
					" 	U.EMAIL, " +
					" 	T.DDD, " +
					" 	T.NUMERO, " +
					...
					" WHERE U.TELEFONE = T.NUMERO " +
											this.montarWherePesquisa(cpf, nome);
	...
	private String montarWherePesquisa(String cpf, String nome){
		
		String where = "";
		
		if(cpf != null && !cpf.isEmpty()){
			where += " AND UPPER(U.CPF) = UPPER('%" + cpf + "%') ";
		}
